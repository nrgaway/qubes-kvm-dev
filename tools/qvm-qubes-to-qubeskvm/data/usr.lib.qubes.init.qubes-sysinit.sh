#!/bin/bash
#echo "qubes-sysinit.sh" >> /usr/lib/qubes/ztmp-script-run-order
...
#### XXX: HACK: REMOVE updates-proxy-setup from TEMPLATEVM condig to enable 
####            network until networking configuration is complete.
